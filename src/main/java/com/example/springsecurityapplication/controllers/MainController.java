...
//    }
    ...
    @GetMapping("/person account/index/info/{id}")
    public String infoProduct(@PathVariable("id") int id, Model model){
        model.addAttribute("product", productService.getProductId(id));
        return "/user/infoProduct";
    }

    @PostMapping("/person account/index/search")
            ...
            if(!price.isEmpty()){
                if(price.equals("sorted_by_ascending_price")) {
                    if (!contract.isEmpty()) {
                        ...
                        } else if (contract.equals("Sportswear")) {
                        ...
                        } else if (contract.equals("Shirts")){
                    ...
                    if(!contract.isEmpty()){
                        ...
                        if(contract.equals("Shoes")){
                            ...
                            model.addAttribute("product_search", productRepository.findByTitleAndCategoryOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 4));
                        } else if (contract.equals("Shirts")){
                            model.addAttribute("product_search", productRepository.findByTitleAndCategoryOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 5));
                        }
                    }  else {
    ...
    public String order(){
        ...
        if (price>0){
            OrderRecord newOrderPerson = new OrderRecord(uuid,personDetails.getPerson(),price,Status.Оформлен);
            orderRecordRepository.save(newOrderPerson);
        }
